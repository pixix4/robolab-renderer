...
fun jwtVerifyRaw(token: String, secret: String, options: dynamic): String =
    jwt.verify(token, secret, options).unsafeCast<String>()
...
class JSONWebToken internal constructor(val dynamic: dynamic, rawToken: String) : BearerToken(rawToken) {
