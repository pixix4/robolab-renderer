...
abstract class RelationalList<T>(
    ...
    override val onRemove = EventHandler<ListRemoveEvent<T>>()
    ...
    override fun invalidate() {
        ...
        while (true) {
            ...
            if (firstToRemove >= 0) {
                val r = oldRelation[firstToRemove]
                onRemove.emit(ListRemoveEvent(firstToRemove, r.element))
    ...
    data class Relation<T>(val index: Int, val hash: Int, val element: T)
}
