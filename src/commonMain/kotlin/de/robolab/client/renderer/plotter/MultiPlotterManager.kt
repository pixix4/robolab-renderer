...
class MultiPlotterManager(
    ...
    private fun createWindow(layout: Rectangle = Rectangle(0.0, 0.0, 1.0, 1.0)): Window {
        ...
        val plotter = PlotterWindow(clippingCanvas, EmptyPlanetDocument(), theme, animationTime)
    ...
    override val plotterList: List<PlotterWindow>
        get() = windowList.map { it.plotter }
    ...
    override val activePlotterProperty = activeWindowProperty.mapBinding { it.plotter }
    override val activePlotter by activePlotterProperty
    ...
    override fun onRender(msOffset: Double): Boolean {
        ...
        for (window in windows) {
            ...
            if (planetDocument is AbstractGroupAttemptPlanetDocument) {
