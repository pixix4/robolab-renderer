...
open class Traverser<M, MS, N, NS>(val mothership: M, val navigator: N, val linkStates: Boolean = true) : ISeededBranchProvider<TraverserState<MS, NS>>,
    ITreeProvider<TraverserState<MS, NS>>
