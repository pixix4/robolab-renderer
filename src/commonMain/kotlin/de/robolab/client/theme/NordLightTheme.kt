...
object NordLightTheme : ITheme {
    ...
    override val ui = object : IThemeUi {
        ...
        override val primaryBackground = Nord.NORD6.color
        override val primaryHoverBackground = Nord.NORD6.color.interpolate(Color.WHITE, 0.2)

        override val secondaryBackground = Nord.NORD5.color
        override val secondaryHoverBackground = Nord.NORD5.color.interpolate(Nord.NORD6.color, 0.5)

        override val tertiaryBackground = Nord.NORD4.color
        override val tertiaryHoverBackground = Nord.NORD4.color.interpolate(Nord.NORD5.color, 0.5)

        override val primaryTextColor = Nord.NORD0.color
        override val secondaryTextColor = Nord.NORD3.color.interpolate(Nord.NORD6.color, 0.3)

        override val themeColor = Nord.NORD10.color
        ...
        override val borderColor = Nord.NORD4.color.interpolate(Nord.NORD3.color, 0.05)

        override val successColor = Nord.NORD14.color
        override val successTextColor = primaryBackground

        override val warnColor = Nord.NORD13.color
        override val warnTextColor = primaryTextColor

        override val errorColor = Nord.NORD11.color
        override val errorTextColor = primaryBackground
    }

    override val editor = object : IThemeEditor {

        // Blue
        override val editorKeywordColor = Nord.NORD8.color.interpolate(Nord.NORD0.color, 0.1)

        // Yellow-Brown
        override val editorDirectionColor = Nord.NORD9.color.interpolate(Nord.NORD0.color, 0.1)

        // Yellow-Green
        override val editorNumberColor = Nord.NORD15.color.interpolate(Nord.NORD0.color, 0.1)

        // Green
        override val editorCommentColor = Nord.NORD4.color.interpolate(Nord.NORD3.color, 0.2)

        // Orange-Brown
        override val editorStringColor = Nord.NORD14.color.interpolate(Nord.NORD0.color, 0.1)

        // Red
        override val editorErrorColor = Nord.NORD13.color.interpolate(Nord.NORD0.color, 0.1)

        // Background highlight
        override val editorSelectedLineColor = Nord.NORD4.color
    }
