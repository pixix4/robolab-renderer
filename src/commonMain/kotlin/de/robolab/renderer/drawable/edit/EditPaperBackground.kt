...
class EditPaperBackground() {
    ...
    private fun update() {
        ...
        for ((view, edge) in edgeList) {
            ...
            view.setColor(ViewColor.PRIMARY_BACKGROUND_COLOR.interpolate(ViewColor.LINE_COLOR, if (selectedEdge == edge) 0.5 else 0.1))
        }
    ...
    companion object {
        ...
        private const val SECOND_MEASURING_LINE_PAPER_DISTANCE: Double = FIRST_MEASURING_LINE_PAPER_DISTANCE + MeasuringLineView.MEASURING_LINE_ENDING_WIDTH / 2
